...
const ConversionOptionsPanel: React.FC<ConversionOptionsPanelProps> = ({
  options,
  optionValues,
  onOptionChange,
}) => {
  ...
  return (
    <div className="mt-4 md:mt-6 p-4 md:p-6 bg-neutral-100 dark:bg-neutral-700/50 rounded-lg shadow">
      <h3 className="text-base md:text-lg font-semibold text-neutral-800 dark:text-neutral-200 mb-3 md:mb-4">
        Conversion Options
      </h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-xs text-yellow-700">
                      <strong>Warning:</strong> No images will be extracted and
                      the original document structure may be broken. This method
                      only extracts text content and creates simple text slides.
                    </p>
                  </div>
                </div>
              </div>
