...
export const ALL_CONVERSION_TASKS: ConversionTask[] = [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        info: 'Re-enter the same password to confirm',
      },
    ],
  },
  {
    ...
    description:
      'Reorder, rotate, or delete pages in a PDF using the interactive page manager.',
  ...
  // == Convert to PDF ==
  {
    ...
    name: 'Image to PDF',
    description:
      'Convert images (JPG, PNG, WEBP, HEIC, GIF) to PDF with advanced editing, layout, and formatting options.',
  ...
  },
  {
    ...
    name: 'Word to PDF',
    description:
      'Convert DOCX and DOC files to PDF, aiming to preserve document structure and appearance.',
  ...
  },
  {
    ...
    options: [
      ...fontOptions,
      ...pageSetupOptions.filter(
        (opt) => opt.id !== 'orientation' && opt.id !== 'pageSize',
      ),
      {
        id: 'pageSize',
        label: 'Page Size',
    ...
    options: [
      {
        ...
        type: 'select',
        defaultValue: 'jpg',
        choices: commonImageOutputFormats,
      },
      {
        id: 'dpi',
        label: 'Image DPI',
  ...
  },
  {
    ...
    supportedOutputFormats: [
      ...
      { value: 'doc', label: 'DOC (Older Word)' },
    ],
    options: [
      {
        id: 'outputFormat',
  ...
  },
  {
    ...
    icon: (
      <FileSpreadsheet className="w-5 h-5 text-green-500 transform -rotate-45" />
    ),
    categoryKey: 'from-pdf',
    supportedInputTypes: ['application/pdf'],
    accept: '.pdf',
  ...
  },
  {
    ...
    icon: (
      <Presentation className="w-5 h-5 text-orange-500 transform -rotate-45" />
    ),
    categoryKey: 'from-pdf',
    supportedInputTypes: ['application/pdf'],
    accept: '.pdf',
    ...
    allowMultipleFiles: false,
    supportedOutputFormats: [
      { value: 'pptx', label: 'PPTX (PowerPoint Presentation)' },
    ],
    options: [
      {
        id: 'conversionType',
        ...
        choices: [
          {
            value: 'image',
            label: 'Image-based (Better quality, preserves layout)',
          },
  ...
  },
  {
    ...
    options: [
      { ...ocrOption, defaultValue: true }, // Default OCR to true for text extraction
      {
        ...
        choices: [
          { value: 'simple', label: 'Simple Text Flow' },
          { value: 'formatted', label: 'Formatted (Attempt to keep layout)' },
        ],
      },
    ],
  },
  {
    ...
    options: [
      ocrOption,
      {
        ...
        type: 'checkbox',
        defaultValue: true,
        info: 'Include images directly in the HTML or link them.',
      },
      {
        id: 'responsive',
        ...
        type: 'checkbox',
        defaultValue: false,
        info: 'Attempt to make the HTML responsive.',
      },
    ],
  },
  {
    ...
    options: [
      ocrOption,
      {
        id: 'pages_per_chapter',
        label: 'Pages per Chapter',
        type: 'number',
        defaultValue: 1,
        min: 1,
        max: 100,
        info: 'Number of pages to group into each chapter. Use 0 for single chapter.',
      },
      {
        id: 'include_images',
        ...
        type: 'checkbox',
        defaultValue: true,
        info: 'Extract and include images from the PDF in the EPUB.',
      },
      {
        id: 'image_quality',
        label: 'Image Quality',
      ...
      },
      {
        ...
        type: 'checkbox',
        defaultValue: true,
        info: 'Attempt to preserve the original PDF layout and formatting.',
      },
      {
        id: 'add_toc',
        ...
        type: 'checkbox',
        defaultValue: true,
        info: 'Generate a table of contents for the EPUB.',
      },
      {
        id: 'custom_title',
        label: 'Custom Title',
        ...
        info: 'Custom title for the EPUB (optional).',
      },
      {
        id: 'custom_author',
        label: 'Custom Author',
        ...
        info: 'Custom author for the EPUB (optional).',
      },
    ],
  },
  {
    ...
    options: [
      ocrOption,
      {
        ...
        defaultValue: 'all',
        info: 'Specify pages or "all" to convert all pages.',
      },
      {
        ...
        type: 'checkbox',
        defaultValue: true,
        info: 'Attempt to preserve original text formatting, fonts, and layout.',
      },
      {
        id: 'include_images',
        label: 'Include Images',
        type: 'checkbox',
        defaultValue: true,
        info: 'Extract and include images from the PDF (may increase file size).',
      },
      {
        id: 'font_size',
        label: 'Base Font Size',
      ...
      {
        id: 'page_breaks',
        label: 'Add Page Breaks',
        type: 'checkbox',
        defaultValue: true,
        info: 'Insert page breaks between PDF pages in the RTF.',
      },
      {
        id: 'custom_title',
        ...
        info: 'Custom title for the RTF document (optional).',
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        min: 100,
        max: 2000,
        info: 'Maximum width in pixels for each page.',
      },
      {
        id: 'height',
        label: 'Max Height',
        ...
        min: 100,
        max: 2000,
        info: 'Maximum height in pixels for each page.',
      },
    ],
  },
]
